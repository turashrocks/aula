...
class phoneCallsControllers extends Controller {
    ...
    public function listAll($page = 1,$search = ""){
        ...
        $toReturn["phone_calls"] = $toReturn["phone_calls"]->select('id','FullName','phoneNo','email','call_type','purpose','call_time','nxt_follow','call_duration')->take('20')->skip(20* ($page - 1) )->get()->toArray();
